...
export declare type HandKeys<S extends "Right" | "Left"> = `${S}${"Wrist" | "RingProximal" | "RingIntermediate" | "RingDistal" | "IndexProximal" | "IndexIntermediate" | "IndexDistal" | "MiddleProximal" | "MiddleIntermediate" | "MiddleDistal" | "ThumbProximal" | "ThumbIntermediate" | "ThumbDistal" | "LittleProximal" | "LittleIntermediate" | "LittleDistal"}`;
export declare type THand<S extends "Right" | "Left"> = Record<HandKeys<S>, XYZ>;
export declare type THandUnsafe<S extends "Right" | "Left"> = Record<HandKeys<S> | string, XYZ>;
