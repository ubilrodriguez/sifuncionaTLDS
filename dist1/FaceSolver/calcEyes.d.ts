 ...
 */
export declare const getEyeOpen: (lm: Results, side?: "left" | "right", { high, low }?: {
 ...
 */
export declare const pupilPos: (lm: Results, side?: "left" | "right") => {
    x: number;
    y: number;
};
/**
 ...
 * @param {String} side : designate "left" or "right"
 */
export declare const getBrowRaise: (lm: Results, side?: "left" | "right") => number;
/**
